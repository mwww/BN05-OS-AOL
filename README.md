...
## Build & Run
To build and install this program, you need to have **CMake** installed ( [CMake download and installation guide](https://cmake.org/cmake/help/latest/guide/tutorial/Before%20You%20Begin.html#getting-cmake) ).
